        ...
        <section id="soporte" className="py-16 lg:py-36 px-5">
            <div className="container flex flex-col lg:flex-row justify-between items-center gap-0 md:gap-16">
                <div className="mb-20 sm:mb-28 max-w-[60rem] mx-auto lg:mt-20 text-center lg:text-start">
                    ...
                    <p className="max-w-[58rem] mx-auto sm:text-lg">Soporte continuo y actualizaciones con nuevas características para garantizar que tu experiencia sea óptima en cada paso del camino. Estamos aquí para responder tus preguntas, resolver problemas y brindarte la asistencia que necesitas para aprovechar al máximo nuestra plataforma.</p>
                </div>

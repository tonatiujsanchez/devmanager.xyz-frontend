...
import { CollaboratorsSection, LoadingMain, Modal, ProjectDescription, TasksSection } from "../components"
        ...
        <>
            ...
            <div className="flex flex-col gap-5 pb-5">
                <div>
                    ...
                    <div 
                        className={`animate-fade line-clamp-1`} 
            ...
            <Modal
                ...
                closeModal={ ()=> setOpenDescription(false) }
            >       
                <ProjectDescription 
                    project={ project } 
                    onCloseModal={ ()=> setOpenDescription(false) }  
                />
            </Modal>
        </>
    )
